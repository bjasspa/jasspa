...
#
#	Run "nmake -f win32vc6.mak"            for optimised build produces ./.win32vc6-release/meicons.exe
#	Run "nmake -f win32vc6.mak BCFG=debug" for debug build produces     ./.win32vc6-debug/meicons.exe
#
...
CCDEFS   = /DWIN32 /D_ME_WINDOW /D_WIN32 /D_WIN32_WINNT=0x500 /W3 /GX
CCFLAGSR = /MD /O2 /DNDEBUG=1
CCFLAGSD = /MDd /Od /Zi /GZ /D_DEBUG
LDDEFS   = /SUBSYSTEM:WINDOWS /INCREMENTAL:NO
...
$(OUTDIR)\$(PRGFILE): $(OUTDIR) $(PRGOBJS)
	$(RM) $@
	$(LD) $(LDDEFS) $(LDFLAGS) /PDB:"$(OUTDIR)\$(PRGNAME).pdb" /OUT:"$@" $(PRGOBJS) $(LDLIBS)
