...
#
#	Run "nmake -f win32vc10.mak"            for optimised build produces ./.win32vc10-release/meicons.exe
#	Run "nmake -f win32vc10.mak BCFG=debug" for debug build produces     ./.win32vc10-debug/meicons.exe
#
...
CCDEFS   = /DWIN32 /D_ME_WINDOW /D_WIN32 /D_WIN32_WINNT=0x0600 /W3 /Zi /D_CRT_SECURE_NO_DEPRECATE /D_CRT_NONSTDC_NO_DEPRECATE
...
.c{$(OUTDIR)}.o:
	$(CC) $(CCDEFS) $(CCFLAGS) /Fd"$(OUTDIR)\vc100.pdb" /c $< /Fo"$@"
