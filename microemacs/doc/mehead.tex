...
\savebox\HeaderImage{\includegraphics[keepaspectratio,height=30pt]{logo.png}}
...
\fancyfoot[OL,ER]{{\small www.jasspa.com} \\
...
\makeatletter
\newcommand\THsection{\@startsection{section}{2}%
{0pt}{-\baselineskip}{.2\baselineskip}%
{\bfseries\Large\centering}}
\newcommand\NHsection{\@startsection{section}{2}%
{0pt}{-\baselineskip}{.2\baselineskip}%
{\bfseries\Large\centering}}
