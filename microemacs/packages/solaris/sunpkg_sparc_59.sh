...
MEBIN=jasspa-me-sun-sparc-59-20040701.gz
...
###     if [ ! -f ${BASEDIR}/src/sunos59.${CCMAK} ] ; then
###         gunzip -c mesrc.tar.gz | (cd ${BASEDIR}/src;  tar xvf - )
###     fi
###     MAKECDEFS="-D_SEARCH_PATH=\\"'"'"${SEARCH_PATH}\\"'"'
###     (cd ${BASEDIR}/src; make -f sunos59.${CCMAK} MAKECDEFS=$MAKECDEFS mecw)
...
###     fi
###     MAKECDEFS="-D_SEARCH_PATH=\\"'"'"${SEARCH_PATH}\\"'"'
###     (cd ${BASEDIR}/src; make -f sunos59.${CCMAK} MAKECDEFS=$MAKECDEFS nec)
###     cp ${BASEDIR}/src/nec ${BASEDIR}/bin/ne
###     (cd ${BASEDIR}/src; make -f sunos59.${CCMAK} spotless)
###     (cd ${BASEDIR}; rm -rf ./src)
###     mkdir ${BASEDIR}/src
### fi
#
...
echo "  zip -9 jasspa-mepkg-sun-sparc-59-20040701.zip jasspa-me"
echo "To test:-"
echo "  mkdir jasspa"
echo "  cd ./jasspa"
echo "  unzip ../jasspa-mepkg-sun-sparc-59-20040701.zip"
