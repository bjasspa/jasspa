...
%  Date          : $Date: 2005-03-11 01:35:24 $
%  Author        : $Author: jon $
%  Created By    : Jon Green
%  Created       : Mon Oct 25 21:36:13 2004
%  Last Modified : <050311.0132>
%
%  Description
%
%  Notes
...
\CVS$Revision: 1.2 $ % or any CVS keyword
\CVS$Date: 2005-03-11 01:35:24 $
...
\end{verbatim}
  ...
  The package is installed in \texttt{/opt/jasspa}. Edit your local shell file
  to include the executable on your local path.
...
\subsection{Running For the First Time}
  ...
  \begin{itemize}
    ...
    that stores company wide company information. The default id dimply called
