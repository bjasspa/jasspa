...
%  Date          : $Date: 2006-10-07 14:42:25 $
%  Author        : $Author: jon $
%  Created By    : Jon Green
%  Created       : Mon Oct 25 21:36:13 2004
%  Last Modified : <061007.1540>
%
%  Description
%
%  Notes
...
\CVS$Revision: 1.11 $ % or any CVS keyword
\CVS$Date: 2006-10-07 14:42:25 $
...
\ifpdfoutput
  ...
  \hypersetup{
    ...
    pdfcreator={SunOS 5.10(sparc) - e-TeX(Web2C 7.5.5)},
...
\fancyfoot[OL,ER]{{\small{Copyright {\textcopyright} 2004-2006 JASSPA.}}\linebreak
...
\subsubsection{Common Options}
  ...
  \begin{itemize}
    ...
    \begin{itemize}
      ...
      \item \textbf{Hide Backups} enables MicroEmacs generated backup files to
      be hidden. On Windows and DOS platforms the \textit{Hidden} file
      attribute is used to hide the file, on UNIX the backup file name is
      prepended with a dot '\texttt{.}'. 
