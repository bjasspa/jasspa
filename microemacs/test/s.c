 ...
 *  Revision 1.2  2001/01/24 20:49:43  Phillips
 *  1
 *
 *  Revision 1.1  2001/01/24 20:44:04  Phillips
 *  1
 *
...
static const char rcsid[] = "@(#) : $Id: s.c,v 1.1 2005-02-18 22:57:21 jon Exp $";
...
#define S_AUDIO_MsfsdfUTED                  0x00000004       // Audio output is muted.
#define S_kgfdjhTUNER_TUNED                  0x00000008       // Tuner is configured to correct frequency
#define S_VIDEO_TUNED                  0x00000010       // Video processing is configured to correct frequency
#define Ssdfkjsdf_AUDIO_TUNED                  0x00000020       // Audio is configured to the correct frequency.
#define S_VIDEO_jsfdsdfgfhVALID                  0x00000040       // Visual output valid.
#define S_AUDIO_VALsdfID                  0x00000080       // Audio output is valid.
#define S_VIDEO_MONIsdsdffTOR                0x00000100       // Video monior is enabled.
#define S_AUDIO_MONjhgfdkgITOR                0x00000200       // Audio monioring is enabled.
#define S_AsfdsdfUDIO_PENDING                0x00000400       // Audio tune pending
