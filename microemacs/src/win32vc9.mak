...
#
#	Run "nmake -f win32vc9.mak"            for optimised build produces ./.win32vc9-release-mew/mew.exe
#	Run "nmake -f win32vc9.mak BCFG=debug" for debug build produces     ./.win32vc9-debug-mew/mew.exe
#	Run "nmake -f win32vc9.mak BTYP=c"     for console support          ./.win32vc9-release-mec/mec.exe
#	Run "nmake -f win32vc9.mak BCOR=ne"    for ne build produces        ./.win32vc9-release-new/new.exe
#
