...
#	Run "nmake -f win32vc9.mak BENV=c"     for console support          ./.win32vc9-release-mec/mec32.exe
#	Run "nmake -f win32vc9.mak BTYP=ne"    for ne build produces        ./.win32vc9-release-new/new32.exe
#
