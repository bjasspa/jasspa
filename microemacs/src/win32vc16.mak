...
CCDEFS   = /DmeVER_CN=$(meVER_CN) /DmeVER_YR=$(meVER_YR) /DmeVER_MN=$(meVER_MN) /DmeVER_DY=$(meVER_DY) /DWIN32 /D_WIN32 /D_WIN32_WINNT=0x0600 /W3 /Zi /D_CRT_SECURE_NO_DEPRECATE /I$(TRDPARTY)\tfs /I$(TRDPARTY)\zlib
...
LDFLAGSR = /OPT:REF /OPT:ICF=5 /LTCG
LDFLAGSD = /DEBUG
