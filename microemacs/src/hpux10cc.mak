...
# hpux10cc.mak - Make file for HP Hpux v10
#
...
# Notes:
#	Run "make -f hpux10cc.mak"      for optimised build produces ./me
#	Run "make -f hpux10cc.mak med"  for debug build produces     ./med
#
#	Run "make -f hpux10cc.mak clean"      to clean source directory
#	Run "make -f hpux10cc.mak spotless"   to clean source directory even more
#
##############################################################################
#
