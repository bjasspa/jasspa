...
#define meSYSTEM_TERMSIG    0x2000000   /* Use SIGTERM, not SIGKILL     */
#define meSYSTEM_CLP_GPRMY  0x4000000   /* Get XA_PRIMARY not CLIPBOARD */
#define meSYSTEM_CLP_SBOTH  0x8000000   /* Set both XA_PRIMARY&CLIPBOARD*/
#define meSYSTEM_NOALTSBUF  0x10000000  /* No Alternative screen buffer */
#define meSYSTEM_IO_UTF8    0x20000000  /* Terminal uses UTF-8 for IO   */

#ifdef _UNIX
#if MEOPT_CLIENTSERVER
#define meSYSTEM_CLNTSRVR_OPT meSYSTEM_CLNTSRVR
#else
#define meSYSTEM_CLNTSRVR_OPT 0
#endif
#if MEOPT_COLOR
#define meSYSTEM_ANSICOLOR_OPT meSYSTEM_ANSICOLOR
#else
#define meSYSTEM_ANSICOLOR_OPT 0
#endif
#define meSYSTEM_MASK (meSYSTEM_ANSICOLOR_OPT|meSYSTEM_CLNTSRVR_OPT|meSYSTEM_FONTS|meSYSTEM_OSDCURSOR|meSYSTEM_DOSFNAMES|meSYSTEM_IPIPES|meSYSTEM_TABINDANY|meSYSTEM_ALTMENU|meSYSTEM_ALTPRFX1|meSYSTEM_KEEPUNDO|meSYSTEM_FONTFIX|meSYSTEM_SHOWWHITE|meSYSTEM_HIDEBCKUP|meSYSTEM_TABINDFST|meSYSTEM_NOEMPTYANK|meSYSTEM_NOCLIPBRD|meSYSTEM_TERMSIG|meSYSTEM_CLP_GPRMY|meSYSTEM_CLP_SBOTH|meSYSTEM_IO_UTF8)
#endif
#ifdef _DOS
...
#endif
#ifdef _WIN32
(meSYSTEM_RGBCOLOR|meSYSTEM_FONTS|meSYSTEM_OSDCURSOR|meSYSTEM_MSSYSTEM|meSYSTEM_DRIVES|meSYSTEM_DOSFNAMES|meSYSTEM_TABINDANY|meSYSTEM_ALTMENU|meSYSTEM_ALTPRFX1|meSYSTEM_FONTFIX|meSYSTEM_CTCHASPC
#if MEOPT_IPIPES
 |meSYSTEM_IPIPES
#endif
);
...
(meSYSTEM_FONTS|meSYSTEM_OSDCURSOR|meSYSTEM_TABINDANY|meSYSTEM_ALTMENU|meSYSTEM_ALTPRFX1|meSYSTEM_KEEPUNDO|meSYSTEM_CTCHASPC|meSYSTEM_SHOWWHITE|meSYSTEM_HIDEBCKUP|meSYSTEM_TABINDFST|meSYSTEM_NOEMPTYANK|meSYSTEM_NOCLIPBRD
#if !defined (_WIN32s)
 |meSYSTEM_CLNTSRVR
#endif
);
