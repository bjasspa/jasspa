...
# irix5gcc.mak - Make file for SGI Irix v5
#
...
# Notes:
#	Run "make -f irix5gcc.mak"      for optimised build produces ./me
#	Run "make -f irix5gcc.mak med"  for debug build produces     ./med
#
#	Run "make -f irix5gcc.mak clean"      to clean source directory
#	Run "make -f irix5gcc.mak spotless"   to clean source directory even more
#
##############################################################################
#
...
CDEFS         = -D_IRIX5 -I. -I../3rdparty/tfs
