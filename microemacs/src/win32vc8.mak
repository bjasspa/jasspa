...
#
#	Run "nmake -f win32vc8.mak"            for optimised build produces ./.win32vc8-release-mew/mew.exe
#	Run "nmake -f win32vc8.mak BCFG=debug" for debug build produces     ./.win32vc8-debug-mew/mew.exe
#	Run "nmake -f win32vc8.mak BTYP=c"     for console support          ./.win32vc8-release-mec/mec.exe
#	Run "nmake -f win32vc8.mak BCOR=ne"    for ne build produces        ./.win32vc8-release-new/new.exe
#
