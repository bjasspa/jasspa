...
# sunosx86cc.mak - Make file for Sunos on x86
#
...
# Notes:
#	Run "make -f sunosx86cc.mak"      for optimised build produces ./me
#	Run "make -f sunosx86cc.mak med"  for debug build produces     ./med
#
#	Run "make -f sunosx86cc.mak clean"      to clean source directory
#	Run "make -f sunosx86cc.mak spotless"   to clean source directory even more
#
##############################################################################
#
