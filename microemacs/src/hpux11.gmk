...
# hpux11.gmk - Make file for HP Hpux v11 using gcc
#
...
# Notes:
#	Run "make -f hpux11.gmk"      for optimised build produces ./me
#	Run "make -f hpux11.gmk med"  for debug build produces     ./med
#
#	Run "make -f hpux11.gmk clean"      to clean source directory
#	Run "make -f hpux11.gmk spotless"   to clean source directory even more
#
##############################################################################
#
