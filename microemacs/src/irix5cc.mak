...
# irix5cc.mak - Make file for SGI Irix v5
#
...
# Notes:
#	Run "make -f irix5cc.mak"      for optimised build produces ./me
#	Run "make -f irix5cc.mak med"  for debug build produces     ./med
#
#	Run "make -f irix5cc.mak clean"      to clean source directory
#	Run "make -f irix5cc.mak spotless"   to clean source directory even more
#
##############################################################################
#
