...
##############################################################################
#
# Created:     Wed Jan 07 2004
# Synopsis:    Make file for OpenBSD using gcc
# Notes:
#	Run "make -f openbsd.gmk"      for optimised build produces ./me
#	Run "make -f openbsd.gmk med"  for debug build produces     ./med
#
#	Run "make -f openbsd.gmk clean"      to clean source directory
#	Run "make -f openbsd.gmk spotless"   to clean source directory even more
#
##############################################################################
#
...
CDEFS         = -D_OPENBSD -I. -I../3rdparty/tfs
