...
# hpux11gcc.mak - Make file for HP Hpux v11 using gcc
#
...
# Synopsis:    Make file for HP Hpux v11 using gcc
# Notes:
#	Run "make -f hpux11gcc.mak"      for optimised build produces ./me
#	Run "make -f hpux11gcc.mak med"  for debug build produces     ./med
#
#	Run "make -f hpux11gcc.mak clean"      to clean source directory
#	Run "make -f hpux11gcc.mak spotless"   to clean source directory even more
#
##############################################################################
#
...
INSTALL       =	install
CDEBUG        = -W -g
COPTIMISE     = -W -O3 -DNDEBUG=1 -Wno-uninitialized
CDEFS         = -D_HPUX11 -D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64 -I. -I../3rdparty/tfs
