...
# macos32cc.mak - Make file for Windows using MinGW development kit.
#
...
#
#	Run "make -f macos32cc.mak"            for optimised build produces ./.macos32cc-release-mew/mecw
#	Run "make -f macos32cc.mak BCFG=debug" for debug build produces     ./.macos32cc-debug-mew/med
#	Run "make -f macos32cc.mak BTYP=c"     for console support          ./.macos32cc-release-mec/mec
#	Run "make -f macos32cc.mak BCOR=ne"    for ne build produces        ./.macos32cc-release-new/ne
#
#	Run "make -f macos32cc.mak clean"      to clean source directory
#	Run "make -f macos32cc.mak spotless"   to clean source directory even more
#
##############################################################################
#
