...
missing_arg:
     ...
     * Need to do this before @file exec as this can be a long process (i.e. ME being used as a shell script engine)
     *
     * Following signals can't be trapped as generated by ME failure and will cause loop
     *
