...
CDEFS         = -D_LINUX -D_LINUX26 -D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64 -I. -I../3rdparty/tfs
...
STDSRC	= abbrev.c basic.c bind.c buffer.c crypt.c dirlist.c display.c \
	  eval.c exec.c file.c fileio.c frame.c hash.c hilight.c history.c input.c \
