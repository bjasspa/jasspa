...
# hpux9gcc.mak - Make file for HP Hpux v9
#
...
# Synopsis:    Make file for HP Hpux v9
# Notes:
#	Run "make -f hpux9gcc.mak"      for optimised build produces ./me
#	Run "make -f hpux9gcc.mak med"  for debug build produces     ./med
#
#	Run "make -f hpux9gcc.mak clean"      to clean source directory
#	Run "make -f hpux9gcc.mak spotless"   to clean source directory even more
#
##############################################################################
#
...
CDEFS         = -D_HPUX9 -I. -I../3rdparty/tfs
