...
MEBIN=jasspa-me-hpux-pa-10.00-${VERSION}.gz
NEBIN=jasspa-ne-hpux-pa-10.00-${VERSION}.gz
...
echo "    #" >> ${DEPOTFILE}
echo "    architecture S700/800_HPUX_10" >> ${DEPOTFILE}
echo "    machine_type 9000/[78]*" >> ${DEPOTFILE}
echo "    os_name HP-UX" >> ${DEPOTFILE}
echo "    os_release ?.10.*" >> ${DEPOTFILE}
