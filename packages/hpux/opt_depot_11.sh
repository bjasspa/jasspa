...
#  Date          : $Date: 2005-02-19 21:19:25 $
#  Author        : $Author: jon $
#  Created By    : <unknown>
#  Created       : Sun Aug 17 12:58:23 2003
#  Last Modified : <050219.2114>
#
...
MEBIN=jasspa-me-hpux-pa-11.00-20050219.gz
...
echo '/usr/sbin/swpackage -d "| /usr/contrib/bin/gzip -c > jasspa-mepkg-hpux-pa-11.00-20050219.depot.gz" -x target_type=tape -s opt_depot_11.psf'
echo ""
echo "To install:-"
echo "/usr/contrib/bin/gunzip -c jasspa-mepkg-hpux-pa-11.00-20050219.depot.gz > jasspa-mepkg-hpux-pa-11.00-20050219.depot"
echo "/usr/sbin/swinstall -s `pwd`/jasspa-mepkg-hpux-pa-11.00-20050219.depot"
echo ""
